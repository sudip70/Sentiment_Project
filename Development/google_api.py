...
def get_place_reviews(place_id):
    ...
    while True:
        ...
        if response.status_code == 200:
            ...
            # Check that the result contains reviews
            ...
            time.sleep(3)  # Wait for a few seconds before fetching 
        else:
...
# Function to print reviews in a readable format
...
def main(query):
    ...
    if place_id:
        ...
        print_reviews(reviews)  # for checking reviews in terminal


if __name__ == "__main__":
    main("Hospitals in brampton")  # replace this with the name of any place
